...
namespace StarterAssets
{
	...
	public class FirstPersonController : NetworkBehaviour
	{
        ...
        {
           // Debug.Log($"Owner: {IsOwner}),Host : {IsHost}, Client:{IsClient}");
		...
		private void Awake()
		{
			...
			if (_mainCamera) {
                _mainCamera.GetComponent<CinemachineVirtualCamera>().Follow = this.followPoint;
            }
		...
		private void LateUpdate()
		{
            ...
            {
                // Point the flashlight towards the hit point
